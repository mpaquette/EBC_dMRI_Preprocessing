...
# mrgrid ${FLASH_DIR_FA05}/data_degibbs_N4_${N4_ITER}x_junarot.nii.gz pad -uniform ${JUNA_PAD} ${JUNA_DIR}/flash1_degibbs_N4_${N4_ITER}x_pad.nii.gz
# mrgrid ${FLASH_DIR_FA12p5}/data_degibbs_N4_${N4_ITER}x_junarot.nii.gz pad -uniform ${JUNA_PAD} ${JUNA_DIR}/flash2_degibbs_N4_${N4_ITER}x_pad.nii.gz
# mrgrid ${FLASH_DIR_FA25}/data_degibbs_N4_${N4_ITER}x_junarot.nii.gz pad -uniform ${JUNA_PAD} ${JUNA_DIR}/flash3_degibbs_N4_${N4_ITER}x_pad.nii.gz
# mrgrid ${FLASH_DIR_FA50}/data_degibbs_N4_${N4_ITER}x_junarot.nii.gz pad -uniform ${JUNA_PAD} ${JUNA_DIR}/flash4_degibbs_N4_${N4_ITER}x_pad.nii.gz
# mrgrid ${FLASH_DIR_FA80}/data_degibbs_N4_${N4_ITER}x_junarot.nii.gz pad -uniform ${JUNA_PAD} ${JUNA_DIR}/flash5_degibbs_N4_${N4_ITER}x_pad.nii.gz
...
# echo -e "\necho \"Check Padded FLASH in JURANOT space.\"" >> $THISLOG
# echo "mrview -load ${JUNA_DIR}/flash1_degibbs_N4_${N4_ITER}x_pad.nii.gz -interpolation 0 -mode 2 -load ${JUNA_DIR}/flash2_degibbs_N4_${N4_ITER}x_pad.nii.gz -interpolation 0 -mode 2 -load ${JUNA_DIR}/flash3_degibbs_N4_${N4_ITER}x_pad.nii.gz -interpolation 0 -mode 2 -load ${JUNA_DIR}/flash4_degibbs_N4_${N4_ITER}x_pad.nii.gz -interpolation 0 -mode 2 -load ${JUNA_DIR}/flash5_degibbs_N4_${N4_ITER}x_pad.nii.gz -interpolation 0 -mode 2" >> $THISLOG

# echo -e "\necho \"Check FLASH mask in JUNAROT space.\"" >> $THISLOG
# echo "mrview -load ${JUNA_DIR}/flash3_degibbs_N4_${N4_ITER}x_pad.nii.gz -interpolation 0 -mode 2 -overlay.load ${JUNA_DIR}/mask_flash_pad.nii.gz -overlay.opacity 0.5 -overlay.interpolation 0 -overlay.colourmap 3" >> $THISLOG


# FIXED1=${JUNA_DIR}/flash1_degibbs_N4_${N4_ITER}x_pad.nii.gz
# FIXED2=${JUNA_DIR}/flash2_degibbs_N4_${N4_ITER}x_pad.nii.gz
# FIXED3=${JUNA_DIR}/flash3_degibbs_N4_${N4_ITER}x_pad.nii.gz
# FIXED4=${JUNA_DIR}/flash4_degibbs_N4_${N4_ITER}x_pad.nii.gz
# FIXED5=${JUNA_DIR}/flash5_degibbs_N4_${N4_ITER}x_pad.nii.gz
...
# echo -e "\necho \"Check Juna registration to JUNAROT space.\"" >> $THISLOG
# echo "mrview  -load ${JUNA_DIR}/flash3_degibbs_N4_${N4_ITER}x_pad.nii.gz -interpolation 0 -mode 2 -load ${OUTPUT} -interpolation 0 -mode 2" >> $THISLOG
